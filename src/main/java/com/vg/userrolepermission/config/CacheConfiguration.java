package com.vg.userrolepermission.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.vg.userrolepermission.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.vg.userrolepermission.repository.UserRepository.USERS_BY_EMAIL_CACHE);
